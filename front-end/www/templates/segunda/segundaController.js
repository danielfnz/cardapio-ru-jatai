...
.controller('SegundaController', function($scope,cardapioFactory,$ionicLoading,$state,$ionicPopup) {
  $scope.almoco;
    $scope.janta;
  $ionicLoading.show({
    content: 'Carregando...',
  ...
  cardapioFactory.getCardapio(1).then(_sucessGet).catch(_errorGet);
  cardapioFactory.getCardapio(6).then(_sucessGet2);

...
.controller('TercaController', function($scope,cardapioFactory,$ionicLoading,$ionicPopup) {
  $scope.almoco;
    $scope.janta;
  $ionicLoading.show({
    content: 'Carregando...',
  ...
  cardapioFactory.getCardapio(2).then(_sucessGet).catch(_errorGet);
  cardapioFactory.getCardapio(7).then(_sucessGet2);
